...
import { MTLLoader } from 'three/examples/jsm/loaders/MTLLoader';
 ...
 const Page = () => {
     ...
     const loaderObj = useCallback(() => {
        const loader = new OBJLoader() 
        loader.setPath('/static/obj/')
        loader.load('2.obj', (obj) => {
            obj.position.set(1, 20, 1)
            obj.scale.set(0.1, 0.1, 0.1)
            Scene.add(obj)
        })
    }, [])
     ...
     loaderMtl.setPath('/static/obj/')
     loaderMtl.load('2.mtl',(masterials)=>{
        loaderObj.setMaterials(masterials)
         masterials.preload()
     })
